...
esp_codec_dev_handle_t bsp_audio_codec_microphone_init(void)
{
    ...
    s_mic_codec_dev = esp_codec_dev_new(&codec_es7210_dev_cfg);
    return s_mic_codec_dev;
}
...
static lv_display_t *bsp_display_lcd_init(const bsp_display_cfg_t *cfg)
{
    ...
    //         panel_handle,
    //         io_handle,
    //         BSP_LCD_H_RES, BSP_LCD_V_RES,                      // 分辨率示例
    //         ESP_LV_ADAPTER_ROTATE_0,      // 旋转
    //         18,                             // TE 引脚 GPIO_NUM_4
    //         80 * 1000 * 1000,             // SPI 刷屏频率 40 MHz
    //         4,                             // 单线 SPI
    //         BSP_LCD_BITS_PER_PIXEL       // RGB565: 16bpp
...
qmi8658_dev_t *bsp_qmi8658_drv_init(void)
{
    ...
    qmi8658_dev_t *_qmi8658_dev = (qmi8658_dev_t *)calloc(sizeof(qmi8658_dev_t),1);
