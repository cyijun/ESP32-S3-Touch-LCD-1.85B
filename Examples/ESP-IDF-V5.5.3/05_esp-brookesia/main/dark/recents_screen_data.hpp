...
constexpr RecentsScreenSnapshot::Data STYLESHEET_360_360_DARK_RECENTS_SCREEN_SNAPSHOT_DATA = {
    .main_size = gui::StyleSize::RECT_PERCENT(40, 47),
    .title = {
        .main_size = gui::StyleSize::RECT_W_PERCENT(40, 20),
        .main_layout_column_pad = 10,
        .icon_size = gui::StyleSize::SQUARE_PERCENT(100),
        .text_font = gui::StyleFont::HEIGHT_PERCENT(90),
        .text_color = gui::StyleColor::COLOR(0xFFFFFF),
    },
    .image = {
        .main_size = gui::StyleSize::RECT_PERCENT(40, 40),
        .radius = 20,
    },
    .flags = {
...
constexpr RecentsScreen::Data STYLESHEET_360_360_DARK_RECENTS_SCREEN_DATA = {
    .main = {
        .y_start = 0,
    ...
    .snapshot_table = {
        ...
        .snapshot = STYLESHEET_360_360_DARK_RECENTS_SCREEN_SNAPSHOT_DATA,
    },
    .trash_icon = {
